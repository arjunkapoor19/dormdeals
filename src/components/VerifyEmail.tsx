...
const VerifyEmail = ({token}: VerifyEmailProps) => {
    ...
    if (isError){
        ...
        <div className="flex flex-col items-center gap-2">
            <XCircle className="h-8 w-8 text-red-600"></XCircle>
            <h3 className="font-semibold font-xl">There was a problem</h3>
        ...
        return (
            <div className="flex h-full flex-col items-center">
                <div className="relative mb-4 h-60 w-60 text-muted-foreground">
                    <Image src = '/kiwi-email-sent.png' fill alt = "the email was sent"/>
                </div>
    ...
    if (isLoading){
        ...
        <div className="flex flex-col items-center gap-2">
            ...
            <h3 className="font-semibold font-xl">Verifying...</h3>
            <p className="text-muted-foreground text-sm">
